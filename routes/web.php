...
Route::group(['middleware' => ['web', 'auth']], function(){
    ...
    Route::group(['middleware' => ['role:admin|user']], function(){
        ...
        Route::post('/pengumuman/insert',[PengumumanController::class,'add'])->name('pengumuman.add');
        Route::POST([PengumumanController::class, 'home'])->name('pengumuman');
        Route::post('/pengumuman/insert/execute',[PengumumanController::class,'store'])->name('addNewItem');
