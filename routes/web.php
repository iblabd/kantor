...
Route::group(['middleware' => ['web', 'auth', 'verified']], function(){
    ...
    Route::group(['middleware' => ['role:admin|user', 'verified']], function(){
        ...
        Route::get('/dashboard/pegawai/{karyawan:user_id}/status', [KaryawanController::class, 'show'])->name('detailPegawai');
        ...
        Route::get('/pengumuman/update/{id}',[PengumumanController::class,'update'])->name('update.pengumuman');
